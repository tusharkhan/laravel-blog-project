...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'publisher_bn' => ['nullable', 'string'],
            'reporter' => ['nullable', 'string'],
            'reporter_bn' => ['nullable', 'string'],
        ...
        $post = Post::create([
            ...
            'slug_bn' => $validated['slug_bn'] ? Str::slug($validated['slug_bn']) : null,
            ...
            'publisher_bn' => $validated['publisher_bn'] ?? null,
            'reporter' => $validated['reporter'] ?? null,
            'reporter_bn' => $validated['reporter_bn'] ?? null,
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($post && Gate::allows('update-post', $post)) {
            ...
            $post->title_bn = $validated['title_bn'] ?? null;
            $post->slug = Str::slug($validated['slug']);
            $post->slug_bn = $validated['slug_bn'] ? Str::slug($validated['slug_bn']) : null;
            $post->category_id = $validated['category'];
            $post->content = $validated['content'];
            $post->content_bn = $validated['content_bn'] ?? null;
            ...
            $post->publisher_bn = $validated['publisher_bn'] ?? null;
            $post->reporter = $validated['reporter'] ?? null;
            $post->reporter_bn = $validated['reporter_bn'] ?? null;
            $post->location = $validated['location'] ?? null;
            $post->location_bn = $validated['location_bn'] ?? null;
